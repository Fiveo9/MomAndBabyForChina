    ...
    sidebar: [
      {
        text: '孕期指南（上海）',
        items: [
          { text: '孕期总览', link: '/P00-孕期总览（上海）' },
          { text: '备孕与孕早期', link: '/P01-备孕与孕早期（上海）' },
          { text: '建档与产检时间表', link: '/P02-建档与产检时间表（上海）' },
          { text: '营养体重与补充剂', link: '/P03-营养体重与补充剂（上海）' },
          { text: '常见不适与红旗信号', link: '/P04-常见不适与红旗信号（上海）' },
          { text: '孕晚期与分娩准备', link: '/P05-孕晚期与分娩准备（上海）' }
        ]
      },
      {
        text: '待产准备',
